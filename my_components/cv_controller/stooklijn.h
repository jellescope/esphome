...
class Stooklijn {
 ...
 protected:
  ...
  // minium aanvoer temperature when the outside temperature is high (voetpunt)
  // need to set this relatively high otherwise the radiators won't produce heat
  // when the outside temperature is above 15 degrees and the room temperature is at 19 degrees burning is inefficient
  const float min_aanvoer_temperature_ = 35;
